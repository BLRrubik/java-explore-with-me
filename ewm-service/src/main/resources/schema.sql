...
ALTER TABLE if EXISTS comments DROP CONSTRAINT if EXISTS fk_comments_event;
ALTER TABLE if EXISTS comments DROP CONSTRAINT if EXISTS fk_comments_author;
...
CREATE TABLE comments(
    ...
    CONSTRAINT fk_comments_author FOREIGN KEY (author) REFERENCES users(user_id)
);
